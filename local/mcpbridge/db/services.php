...
$functions = [
    ...
    'local_mcpbridge_add_essay_question' => [
        'classname'    => 'local_mcpbridge\external\add_essay_question',
        'methodname'   => 'execute',
        'description'  => 'Add an essay (free-text, manually graded) question to a quiz',
        'type'         => 'write',
        'capabilities' => 'mod/quiz:manage, moodle/question:add',
        'ajax'         => false,
    ],
    'local_mcpbridge_add_numerical_question' => [
        'classname'    => 'local_mcpbridge\external\add_numerical_question',
        'methodname'   => 'execute',
        'description'  => 'Add a numerical question (with tolerances) to a quiz',
        'type'         => 'write',
        'capabilities' => 'mod/quiz:manage, moodle/question:add',
        'ajax'         => false,
    ],
    'local_mcpbridge_add_matching_question' => [
        'classname'    => 'local_mcpbridge\external\add_matching_question',
        'methodname'   => 'execute',
        'description'  => 'Add a matching (pair the items) question to a quiz',
        'type'         => 'write',
        'capabilities' => 'mod/quiz:manage, moodle/question:add',
        'ajax'         => false,
    ],
    'local_mcpbridge_backup_course' => [
        'classname'    => 'local_mcpbridge\external\backup_course',
        'methodname'   => 'execute',
        'description'  => 'Back a course up to a .mbz file (returned base64-encoded)',
        'type'         => 'read',
        'capabilities' => 'moodle/backup:backupcourse',
        'ajax'         => false,
    ],
    'local_mcpbridge_restore_course' => [
        'classname'    => 'local_mcpbridge\external\restore_course',
        'methodname'   => 'execute',
        'description'  => 'Restore a .mbz backup (base64) into a brand-new course',
        'type'         => 'write',
